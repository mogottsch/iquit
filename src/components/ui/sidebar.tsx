...
interface SidebarContextType {
  ...
  openMobile: boolean;
  setOpenMobile: (openMobileValue: boolean) => void;
  isMobile: boolean;
  toggleSidebar: () => void;
}
...
>(
  (
    { defaultOpen = true, onOpenChange: setOpenProp, className, style, children, ...props },
    ref
  ) => {
    ...
    // We use setOpenProp for control from outside the component.
    const [_open, _setOpen] = React.useState(defaultOpen);
    const setOpen = React.useCallback(
      (newValue) => {
        const openState = typeof newValue === 'function' ? newValue(_open) : newValue;
        if (setOpenProp) {
